generate_model_from_modulenet <- dynutils::inherit_default_params(c(add_targets_realnet, modulenet_to_genenet, generate_random_tree, randomize_gene_kinetics), generate_model_from_modulenet)
