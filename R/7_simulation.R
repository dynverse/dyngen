...
#' @param compute_log_propensity_ratios Whether or not to compute the propensity ratios after simulation.
...
simulation_default <- function(
  ...
  compute_dimred = TRUE,
  compute_log_propensity_ratios = FALSE,
...
.generate_cells_simulate_cell <- function(simulation_i, model, reactions, verbose = FALSE, debug = FALSE) {
  ...
  log_propensity <- sim_params$store_reaction_propensities || sim_params$compute_log_propensity_ratios
