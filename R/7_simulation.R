...
#' @param kinetic_noise_strength The standard deviation of the randomly added kinetics each simulation.
#' 
...
.generate_cells_simulate_cell <- function(simulation_i, model, reactions, verbose = FALSE, debug = FALSE) {
  ...
  lst(meta, counts, regulation, reaction_firings, reaction_propensities, kd_multiplier)
}
