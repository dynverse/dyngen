...
## Installation
You can install dyngen by running the following command.
```r
install.packages("remotes")
remotes::install_github("dynverse/dyngen", dependencies = TRUE)
```

This software should work on Linux, Mac OS X, and Windows, for versions R 3.5 and upwards, and is tested with [Github Actions](https://github.com/dynverse/dyngen/actions?query=workflow%3AR-CMD-check).
