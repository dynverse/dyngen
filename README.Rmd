...
To do this, you can pass these parameters manually to the `initialise_model()` function, or 
add these values to your R profile (recommended). You can edit your R profile as follows:
