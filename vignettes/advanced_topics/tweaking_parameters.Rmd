...
```{r initial_run, fig.width = 10, fig.height = 6}
library(dyngen)
library(tidyverse)
...
```{r run1_model, fig.width = 10, fig.height = 6}
...
```{r run2, fig.width = 10, fig.height = 6}
run2_config <- 
  initialise_model(
    backbone = backbone,
    num_tfs = num_tfs,
...
```{r run2_model, fig.width = 10, fig.height = 6}
...
```{r simexp_run2, fig.width = 10, fig.height = 6}
...
```{r run3, fig.width = 10, fig.height = 6}
run3_config <- 
  initialise_model(
    backbone = backbone,
    num_tfs = num_tfs,
...
```{r run4, fig.width = 10, fig.height = 6}
...
```{r run4_model, fig.width = 10, fig.height = 6}
