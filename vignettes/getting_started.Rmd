...
rmarkdown::render("vignettes/getting_started.Rmd", output_format = "github_document")
-->

## Installation
To install dyngen, run `install.packages("dyngen")`.

It's recommended to let dyngen know where it can cache downloaded files and how 
many cores the host system has. You can edit your R profile as follows:
